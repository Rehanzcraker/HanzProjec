...
cd /usr/bin
wget https://raw.githubusercontent.com/Rehanzcraker/HanzProjec/main/limit/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
cd /root
wget https://raw.githubusercontent.com/Rehanzcraker/HanzProjec/main/limit/regis.zip
unzip regis.zip
rm -rf regis.zip
