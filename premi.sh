...
Exp1=$(curl https://raw.githubusercontent.com/BvsshXyz/v2/main/izinv2 | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/BvsshXyz/v2/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/BvsshXyz/v2/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/BvsshXyz/v2/main/izin | grep $ipsaya | awk '{print $3}')
